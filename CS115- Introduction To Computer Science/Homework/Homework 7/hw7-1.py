...
def testCode():
    '''tests the code'''
    assert (uncompress(compress(L0))=='1110001111001010')
    assert (uncompress(compress(L1))=='1')
    assert (uncompress(compress(L2))=='111111110101010101010101010101010101010101')
    assert (uncompress(compress(L3))=='110011001100')
    assert (uncompress(compress(L4))=='000111000111')
    assert (uncompress(compress(L5))=='0000111100001111')
    assert (uncompress(compress(L6))=='0' * MAX_RUN_LENGTH + '1' * MAX_RUN_LENGTH + '0' * (64 - 2 * MAX_RUN_LENGTH))
    assert (uncompress(compress(L7))=='0' * (MAX_RUN_LENGTH + 1) + '1' * (MAX_RUN_LENGTH + 1) + '0' * (64 - 2 * MAX_RUN_LENGTH - 2))
    assert (uncompress(compress(L8))=='1' * MAX_RUN_LENGTH + '0' * MAX_RUN_LENGTH + '1' * (64 - 2 * MAX_RUN_LENGTH))
    print('The code is working for me :)')
