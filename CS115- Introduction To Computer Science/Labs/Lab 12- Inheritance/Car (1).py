...
class Car(object):
    ...
    def __init__(self, make, model, mpg, tank_capacity):
        '''Initializer for the Car object'''
        self.__make= make
        self.__model= model
        self.__mpg= mpg
    ...
    def get_make(self):
        '''returns the company name of the car object.'''
        return self.__make
    def get_model(self):
        '''returns the model of the car object.'''
        return self.__model
    def get_mpg(self):
        '''returns the miles per gallon of the car object.'''
        return self.__mpg
    def get_tank_capacity(self):
        '''returns the tank capacity of the car object.'''
        return self.__tank_capacity

    def set_mpg(self, mpg):
        '''sets the miles per gallon of the car object.'''
        self.__mpg= mpg
    def set_tank_capacity(self, tC):
        '''sets the tank capacity of the car object.'''
        self.__tank_capacity= tC
        
    def get_total_range(self):
        '''returns the total range of the car object.'''
...
class HybridCar(Car):  
    ...
    def __init__(self, make, model, mpg, tank_capacity, battery_kWh, miles_per_kWh):
        '''Constructor for the Hybrid Car object.'''
    ...
    def get_total_range(self):
        '''returns the total range of the hybrid car object.'''
