...
0       read    r1         # Get n
1       jeqzn   r1 13      # Jump to 13 if the input is 0
2       setn    r2 0        # Sets r2 to first value next in fibonacci sequence
3       setn    r3 1        # Sets r3 to second value next in fibonacci sequence
4       write   r2          # Prints the value for r2
5       addn    r1 -1       # Subtracts 1 from r1
6       jeqzn   r1 13       # Jump to 13 if r1 is 0
7       add     r2 r2 r3    # Adds r2 and r3, becoming the new r2
8       write   r3          # Prints the value for r3
9       addn    r1 -1       # Subtracts 1 from r1
10      jeqzn   r1 13       # Jump to 13 if r1 is 0
11      add     r3 r2 r3    # Adds r2 and r3, becoming the new r3
12      jumpn   4           # Jumps to 4
13      halt                #halts
