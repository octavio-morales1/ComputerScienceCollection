/*******************************************************************************
 * Name        : rbtree.h
 * Author      : Brayan Paredes, Octavio Morales
 * Version     : 1.0
...
private:
    ...
    int diameter(Node<K, V> *node) const {
        ...
        int comHeight= heightLeft+heightRight;
        int maxDiameter= 0;

        //comparing diameters to get max
        if(diameterLeft<diameterRight){
        	maxDiameter= diameterRight;
        }
        else{
        	maxDiameter= diameterLeft;
        }

        //comparing combined heights and max diameters
        if(comHeight<maxDiameter){
        	return maxDiameter;
        }
        return comHeight;
    }
